      ...
      <div className="hall-container">
        <div className="hall-main-info">
          ...
          <div className="hall-info-right">
            ...
            <h3>Hall Meetings</h3>
            <p>
              Looking for perfect destination to spend a quality time with good
              food and peaceful environment? Come pay us a visit today! Looking
              for perfect destination to spend a quality time with good food and
